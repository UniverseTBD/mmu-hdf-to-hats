"""
DESY3SNEIaTransformer: Clean class-based transformation from HDF5 to PyArrow tables.
"""
...
class DESY3SNEIaTransformer(BaseTransformer):
    """Transforms DES Y3 SNE Ia HDF5 files to PyArrow tables with proper schema."""

    # Feature definitions from des_y3_sne_ia.py
