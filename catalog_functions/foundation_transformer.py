"""
FoundationTransformer: Clean class-based transformation from HDF5 to PyArrow tables.
"""
...
class FoundationTransformer(BaseTransformer):
    """Transforms Foundation DR1 HDF5 files to PyArrow tables with proper schema."""

    # Feature definitions from foundation.py
    ...
    def dataset_to_table(self, data):
        ...
        # 2. Parse bands (comma-separated string)
