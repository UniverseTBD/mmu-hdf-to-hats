...
This repository contains code for converting the Multimodal Universe into HATS format, to eventually ease the use of server-side crossmatching on Hugging Face as part of the [MMU-Streaming project](https://discord.gg/caqxB63DPd).
